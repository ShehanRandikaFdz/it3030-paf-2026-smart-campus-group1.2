        ...
        <div className="login-page">
            ...
            <div className="login-card">
                ...
                >
                    ...
                    <span style={{ lineHeight: '20px' }}>{signingIn ? 'Redirecting to Google...' : 'Continue with Google'}</span>
                </button>

                {/* Footer */}
                <p className="login-footer">
                    Use your university Google account to access the campus operations dashboard
                </p>
